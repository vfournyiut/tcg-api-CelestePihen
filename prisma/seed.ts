...
async function main() {
  ...
  console.log(
    `✅ Created Starter Deck for ${redUser.username} with ${redStarterCards.length} cards`,
  )
  ...
  console.log(
    `✅ Created Starter Deck for ${blueUser.username} with ${blueStarterCards.length} cards`,
  )
